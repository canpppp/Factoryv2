...
| Invoice Audit | `/Users/can/Downloads/Documents/Invoices/invoice-audit` | Existing `PROJECT_BRIEF.md` identifies Invoice Audit and the git remote is `canpppp/invoice-audit` | Configured, read-only |
